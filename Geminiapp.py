...
if st.button("Get Recommendations!"):
    try:
        ...
        user_data = f"Age: {age}, Gender: {gender}, Weight: {weight} kg, Height: {height} cm, Waist: {waist} cm, Neck: {neck} cm, Activity: {activity}, Diet Preference: {diet_preference}, Disease: {disease}, Region: {region}, Allergies: {allergies}, Food Type: {food_type}"
